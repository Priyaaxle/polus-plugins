...
The feature extraction plugin extracts shape and intensity based features from 2D and 3Dimages and outputs csv file.The input image should be in OME tiled tiff format.
...
Note:
Perimeter, Orientation, Eccentricity, Hexagonality score, Hexagonality standard deviation, Polygonality score, Maximum feret, Minimum feret and Neighbors not implemented for 3D images.
